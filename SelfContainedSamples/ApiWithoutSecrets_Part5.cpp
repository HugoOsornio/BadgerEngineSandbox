...
{
	std::string vertexShaderPath(std::string(API_WITHOUT_SECRETS_PART5_CONTENT) + "vert.spv");
	...
	std::string fragmentShaderPath(std::string(API_WITHOUT_SECRETS_PART5_CONTENT) + "frag.spv");
...
void initWindow()
{
	...
	window = glfwCreateWindow(1920, 1080, "ApiWithoutSecrets_Part5", nullptr, nullptr);
